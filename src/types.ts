...
declare global {
  export namespace JSX {
    ...
    export type Element = IntermediateRepresentation | string | number

    export interface IntermediateRepresentation<P = { children?: Children }> {
    ...
    export type ClassName = string | Array<string | boolean>
