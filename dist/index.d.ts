export type Component<P extends {} = {}> = (props: JSX.PropsWithChildren<P>) => JSX.Element | null;
export interface IntermediateRepresentation<P = {}> {
    type: string | Component;
    props: JSX.PropsWithChildren<P>;
}
export declare const html: (elem: JSX.Element) => string;
export declare const dom: (elem: IntermediateRepresentation | string) => Array<HTMLElement | string>;
...
declare global {
    export namespace JSX {
        ...
        interface SVGAttributes<Target extends EventTarget = SVGElement> extends HTMLAttributes<Target> {
            ...
            alignmentBaseline?: 'auto' | 'baseline' | 'before-edge' | 'text-before-edge' | 'middle' | 'central' | 'after-edge' | 'text-after-edge' | 'ideographic' | 'alphabetic' | 'hanging' | 'mathematical' | 'inherit' | undefined | SignalLike<'auto' | 'baseline' | 'before-edge' | 'text-before-edge' | 'middle' | 'central' | 'after-edge' | 'text-after-edge' | 'ideographic' | 'alphabetic' | 'hanging' | 'mathematical' | 'inherit' | undefined>;
            ...
            arabicForm?: 'initial' | 'medial' | 'terminal' | 'isolated' | undefined | SignalLike<'initial' | 'medial' | 'terminal' | 'isolated' | undefined>;
            ...
            colorInterpolationFilters?: 'auto' | 'sRGB' | 'linearRGB' | 'inherit' | undefined | SignalLike<'auto' | 'sRGB' | 'linearRGB' | 'inherit' | undefined>;
            ...
            fillRule?: 'nonzero' | 'evenodd' | 'inherit' | undefined | SignalLike<'nonzero' | 'evenodd' | 'inherit' | undefined>;
            ...
            strokeLinecap?: 'butt' | 'round' | 'square' | 'inherit' | undefined | SignalLike<'butt' | 'round' | 'square' | 'inherit' | undefined>;
            strokeLinejoin?: 'miter' | 'round' | 'bevel' | 'inherit' | undefined | SignalLike<'miter' | 'round' | 'bevel' | 'inherit' | undefined>;
        ...
        interface DOMAttributes<Target extends EventTarget> extends PropsWithChildren<{}> {
        ...
        interface HTMLAttributes<RefType extends EventTarget = EventTarget> extends DOMAttributes<RefType>, AriaAttributes {
            ...
            enterkeyhint?: 'enter' | 'done' | 'go' | 'next' | 'previous' | 'search' | 'send' | undefined | SignalLike<'enter' | 'done' | 'go' | 'next' | 'previous' | 'search' | 'send' | undefined>;
            ...
            readOnly?: boolean | undefined | SignalLike<boolean | undefined>;
            referrerpolicy?: 'no-referrer' | 'no-referrer-when-downgrade' | 'origin' | 'origin-when-cross-origin' | 'same-origin' | 'strict-origin' | 'strict-origin-when-cross-origin' | 'unsafe-url' | undefined | SignalLike<'no-referrer' | 'no-referrer-when-downgrade' | 'origin' | 'origin-when-cross-origin' | 'same-origin' | 'strict-origin' | 'strict-origin-when-cross-origin' | 'unsafe-url' | undefined>;
            ...
            autocapitalize?: 'off' | 'none' | 'on' | 'sentences' | 'words' | 'characters' | undefined | SignalLike<'off' | 'none' | 'on' | 'sentences' | 'words' | 'characters' | undefined>;
            autoCapitalize?: 'off' | 'none' | 'on' | 'sentences' | 'words' | 'characters' | undefined | SignalLike<'off' | 'none' | 'on' | 'sentences' | 'words' | 'characters' | undefined>;
        ...
        interface HTMLMarqueeElement extends HTMLElement {
            behavior?: 'scroll' | 'slide' | 'alternate' | undefined | SignalLike<'scroll' | 'slide' | 'alternate' | undefined>;
            bgColor?: string | undefined | SignalLike<string | undefined>;
            direction?: 'left' | 'right' | 'up' | 'down' | undefined | SignalLike<'left' | 'right' | 'up' | 'down' | undefined>;
            height?: number | string | undefined | SignalLike<number | string | undefined>;
